  ...
  React.useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        let avatar = "/images/user/owner.jpg"; // Default
        ...
        try {
          ...
          if (doc.avatar) avatar = doc.avatar;
        } catch (e) {
          // Document might not exist or no avatar
        }
        ...
        console.error("Failed to fetch user for dropdown", e);
      }
    };
    fetchUser();
  }, []);
        ...
        <button
          onClick={async () => {
            try {
              ...
              window.location.href = "/signin"; // Force reload to clear state
            } catch (error) {
