...
const samplePackages = [
  {
    ...
    description:
      "Experience the serene backwaters, tea plantations of Munnar, and the pristine beaches of Kovalam in this comprehensive Kerala tour.",
    highlights: [
      "Houseboat Stay",
      "Tea Plantations",
      "Kathakali Dance",
    ...
    itinerary: [
      {
        ...
        description: "Arrive at Cochin Airport and transfer to Munnar.",
        activities: ["Airport Pickup", "Scenic Drive"],
      },
      {
        day: 2,
        title: "Munnar Sightseeing",
        description: "Visit Tea Museum, Mattupetty Dam, and Eco Point.",
        activities: ["Tea Museum", "Mattupetty Dam"],
      },
    ],
    isActive: true,
  ...
  },
  {
    ...
    description:
      "Witness the glitz and glamour of Dubai. From the heights of Burj Khalifa to the thrill of desert safaris.",
    highlights: [
      "Burj Khalifa",
      "Desert Safari",
      "Dubai Mall",
    ...
    itinerary: [
      {
        ...
        description: "Arrive at Dubai and enjoy evening Dhow Cruise.",
        activities: ["Airport Transfer", "Dhow Cruise"],
      },
      {
        day: 2,
        title: "City Tour & Burj Khalifa",
        description: "Half-day city tour and Burj Khalifa visit.",
        activities: ["Dubai Mall", "Burj Khalifa"],
      },
    ],
    isActive: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    description:
      "Explore the cultural heritage of India with the classic Golden Triangle circuit - Delhi, Agra, and Jaipur.",
    ...
    itinerary: [
      {
        ...
        description: "Visit Qutub Minar, India Gate, and Lotus Temple.",
        activities: ["Qutub Minar", "India Gate"],
      },
      {
        day: 2,
        title: "Delhi to Agra",
        description: "Drive to Agra and visit Taj Mahal at sunset.",
        activities: ["Agra Fort", "Taj Mahal"],
      },
    ],
    isActive: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    description:
      "A journey through the royal history of London to the breathtaking landscapes of Scotland.",
    highlights: [
      "Big Ben",
      "Edinburgh Castle",
      "Loch Ness",
    ...
    itinerary: [
      {
        ...
        description: "Arrive in London and check into hotel.",
        activities: ["Airport Transfer", "Leisure Walk"],
      },
      {
        day: 2,
        title: "London Tour",
        description: "Visit Buckingham Palace, Big Ben, and London Eye.",
        activities: ["Buckingham Palace", "London Eye"],
      },
    ],
    isActive: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    description:
      "Escape to the crystal-clear waters and overwater villas of the Maldives for the ultimate beach getaway.",
    highlights: [
      "Overwater Villa",
      "Snorkeling",
      "Sunset Cruise",
    ...
    itinerary: [
      {
        ...
        activities: ["Speedboat Transfer", "Welcome Drink"],
      },
      {
        day: 2,
        title: "Water Activities",
        description: "Snorkeling, kayaking, and beach relaxation.",
...
async function seedPackages() {
  ...
  if (!PROJECT_ID || !API_KEY) {
    console.error(
      "❌ Missing PROJECT_ID or API_KEY. Set environment variables first."
    );
    process.exit(1);
  }
  ...
  for (const pkg of samplePackages) {
    try {
      ...
      delete (payload as any).createdAt; // Remove invalid attribute
      ...
      console.log(`✅ Created: ${pkg.title} (${row.$id})`);
    } catch (error: any) {
